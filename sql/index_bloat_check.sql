...
SELECT
	...
	--table_name,
	index_name,
    pg_size_pretty(totalbytes) as disk_size,
	pg_size_pretty(totalbytes - wastedbytes) as actual_size,
	pg_size_pretty(wastedbytes) as bloat_size,
	round(100*wastedbytes / (totalbytes - wastedbytes)) || ' %%' as bloat_pct
FROM raw_bloat
where table_name='bloated'